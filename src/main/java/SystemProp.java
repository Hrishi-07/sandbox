...
import discUsage.DiscDetails;
import discUsage.SystemPropertiesCpuDetails;
import discUsage.SystemPropertiesRamDetails;
...
//				.println("Number of file handles open : " + Integer.parseInt(iobj.linuxCommandReader(cmdHandleCount)));
	...
	public void diskUsageLinux(String processName) throws IOException {
